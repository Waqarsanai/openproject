...
module Admin
  module Settings
    class RepositoriesCheckoutForm < ApplicationForm
      ...
      form do |f|
        f.check_box(
          ...
          data: {
            ...
            target_name: "#{setting_base}_enabled"
          }
          ...
          setting_repository_checkout_check_box.nested_form(
            ...
            ProfileForm.new(builder, setting_base:, vendor:)
          end
        end
      end
    end
